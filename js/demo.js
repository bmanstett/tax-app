...
const Demo = (() => {
  ...
  function load() {
    ...
    /* ---- Work orders ---- */
    // every demo job is inspected in PA; the office work happens in the configured office state
    const woDefaults = { fieldEngineer: "B. Anstett, PE", peNumber: "PE-088214", coaNumber: "COA-4471", feeType: "Flat Fee", mileageAllowed: true, mileageAmount: "IRS rate", serviceType: "Forensic Engineering Report", workState: "PA", officeState: S.settings.officeState || "VA", fieldWorkPct: S.settings.defaultFieldWorkPct ?? 50 };
